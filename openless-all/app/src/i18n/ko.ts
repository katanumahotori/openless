...
export const ko: typeof zhCN = {
  ...
  style: {
    ...
    customMode: {
      title: '사용자 스타일',
      desc: '내장 4가지 스타일에 더해 자체 system prompt를 가진 사용자 스타일을 자유롭게 추가할 수 있습니다.',
      addButton: '+ 새 사용자 스타일 추가',
      empty: '사용자 스타일이 아직 없습니다.',
      idLabel: 'ID (변경 불가)',
      idPlaceholder: '예: my-style',
      idHint: '영숫자와 하이픈만 사용 가능. 콜론(:)은 사용할 수 없습니다.',
      nameLabel: '표시 이름',
      namePlaceholder: '예: 잡기용',
      promptLabel: 'system prompt 본문',
      promptPlaceholder: 'LLM에 전달할 지시문을 직접 작성하세요...',
      delete: '삭제',
      edit: '편집',
      save: '저장',
      cancel: '취소',
      viewBuiltinPrompt: '기본 prompt 보기',
      hideBuiltinPrompt: '닫기',
      confirmDelete: '이 사용자 스타일을 삭제하시겠습니까?',
      idEmpty: 'ID를 입력하세요.',
      idInvalid: 'ID는 영숫자와 하이픈만 사용 가능합니다.',
      nameEmpty: '표시 이름을 입력하세요.',
      promptEmpty: 'system prompt를 입력하세요.',
    },
    appOverride: {
      title: '앱별 자동 전환',
      desc: '특정 앱에서 받아쓰기를 할 때 해당 스타일을 자동으로 적용합니다. 패턴은 프로세스 이름의 일부와 일치합니다(예: chrome, Discord.exe). 일치하지 않으면 기본 스타일이 사용됩니다.',
      addButton: '+ 새 규칙 추가',
      empty: '아직 규칙이 없습니다. "+ 새 규칙 추가"를 눌러 시작하세요.',
      patternLabel: '앱 이름(부분 일치)',
      patternPlaceholder: '예: chrome / Discord.exe',
      modeLabel: '적용할 스타일',
      delete: '삭제',
      hint: '위에서 아래 순서로 평가되며, 가장 먼저 일치한 규칙이 적용됩니다. 대소문자는 구분하지 않습니다.',
    },
  },
  translation: {
    kicker: 'TRANSLATION',
    ...
    enable: {
      title: '번역 기능 사용',
      hint: '끄면 단축키가 잘못 눌려도 번역 파이프라인과 UI 오버레이가 시작되지 않습니다.',
    },
    working: {
      title: '작업 언어',
  ...
  modal: {
    ...
    personalize: {
      ...
      fontMedium: '중',
      fontLarge: '대',
      fontFamilyLabel: 'UI 글꼴',
      fontFamilyDesc: '앱 내부 표시 글꼴을 전환합니다. 일본어가 중국어 글꼴로 렌더링될 때 또는 선호하는 글꼴로 바꿀 때 유용합니다.',
      fontFamilyAuto: '자동 (기본 우선순위)',
      fontFamilyCustomLabel: '사용자 지정 (자유 입력)…',
      fontFamilyCustomPlaceholder: '글꼴 이름 입력 (예: Yu Gothic UI)',
      fontInstalledLabel: '설치된 글꼴 ({{count}})',
      fontLoadAll: '모든 글꼴 불러오기',
      fontReload: '다시 불러오기 ({{count}})',
      fontLoading: '가져오는 중…',
      fontLoadError: '글꼴 목록을 가져올 수 없습니다 (권한 거부 또는 미지원 환경)',
      quietLabel: '조용 모드',
      quietDesc: '녹음 파형과 처리 중 점 애니메이션은 유지하면서 "번역 중", "N자 입력됨", "취소됨" 같은 일시적 텍스트 표시를 억제합니다. 오류는 계속 표시됩니다.',
      quietAria: '조용 모드 전환',
      blur: '서리유리 강도',
